    ...
    const navHTML = `
        <nav style="background: #1e293b; padding: 1rem; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #334155; font-family: sans-serif;">
            <div style="display: flex; align-items: center; gap: 20px;">
                <a href="/" style="color: white; text-decoration: none; font-weight: bold; font-size: 1.2rem;">Cognis11</a>
                <a href="/members/account.html" style="color: #94a3b8; text-decoration: none; font-size: 0.9rem;">Account</a>
            </div>
